  ...
  return (
    <Layout subtitle="Como Comprar">
      <div className="w-full flex flex-col p-4 gap-4 mb-12 sm:p-8">
        <header className="">
          <h2 className="text-xl font-medium sm:text-3xl sm:text-center">
            Como comprar en <b>ClosetWithoutGender</b>
          </h2>
        </header>
        <article className="w-full flex flex-col gap-2">
          <b className="text-lg sm:text-2xl">¿Cómo comprar?</b>

          <ul className="flex flex-col gap-2">
            <li>
              <b className="sm:text-xl">1° Mirá nuestros productos:</b>{" "}
              <p className="text-sm sm:w-[80%] sm:text-lg">
          ...
          <b className="text-lg sm:text-xl mt-4">
